...
namespace StringExtensionLibrary
{
    ...
    public static class StringExtensions
    {
        ...
        {
            return DateTime.TryParseExact(data, dateFormat, CultureInfo.InvariantCulture, DateTimeStyles.None, out _);
        }
        ...
        {
            _ = long.TryParse(value, out long number);
            return number;
        }
        ...
        {
            _ = short.TryParse(value, out short number);
            return number;
        }
        ...
        {
            _ = decimal.TryParse(value, out decimal number);
            return number;
        }
        ...
        public static bool IsInteger(this string val) => int.TryParse(val, NumberStyles.Any, NumberFormatInfo.InvariantInfo, out _);
